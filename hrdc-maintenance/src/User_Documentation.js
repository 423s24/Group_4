...
const User_Documentation = () => {
    return (
        <div id="user_documentation_text">
            ...
            <h3>Description</h3>
            <ul>
                <li>Allows tennents to create a maintenence request online.</li>
                <li>This will improve accissibility for tennets as it simplifies the maintenence request submittal process.</li>
                <li>This system sends an email to the maintenence team manager with the details entered in the form.</li>
            </ul>
            ...
            <ul>
                ...
                <li>That's all! If you fill out the form on the page and click submit, it will submit a maintenence request.</li>
            </ul>
            ...
            <ul>
                ...
                <li>In the field titled <q>Message</q>, enter a description of the issue you want the maintenence team to address. This should include any details you think the team should know.</li>
                ...
                <li>In the field titled <q>Maintenence Category</q>, use the dropdown menu to select the category you maintenence issue belongs to. If you do not see the menu, click the words <q>Select a Category</q>.</li>
                ...
                <li>In the field titled <q>Permission To Key Into This Unit</q>, use the dropdown menu to select either <q>Yes</q> or <q>No</q>. Selecting yes indicates that you give your consent to the HRDC maintenence team to enter your unit to resolve the issue even if you are no home at the time.</li>
            </ul>
        </div>
    )
